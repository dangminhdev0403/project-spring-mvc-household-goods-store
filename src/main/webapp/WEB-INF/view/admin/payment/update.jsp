  ...
  <div class="page-inner">
    <div class="page-header">
      ...
      <ul class="breadcrumbs mb-3">
        ...
        <li class="nav-item">
          <a href="/admin/payment/update/${newPayment.id}">Cập nhật thanh toán</a>
        </li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <div class="card-title">Cập nhật thanh toán</div>
          </div>
          <form:form
              ...
              <div class="row">
                ...
                <div class="col-md-6 col-lg-4 ">
                  ...
                  <div class="preview-container form-group">
                      ...
                      <img class="imagePreview" src="${newPayment.urlIcon != null ?  newPayment.urlIcon : ''}" alt="Preview" style="max-width: 283px; display: block;" >
                  </div>
                  </div>
                </div>
              </div>
