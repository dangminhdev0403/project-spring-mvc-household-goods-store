...
<footer id="footer" class="footer">
    <div class="container">
        <div class="footer__row">
            ...
            <div class="footer__col">
                ...
                <a href="/" class="logo footer__logo">
                    <img src="/client/assets/icons/logo.svg" alt="Chợ Gia Dụng" class="logo__img" />
                    <h1 class="logo__title">Chợ Gia Dụng</h1>
                </a>
                <p class="footer__desc">
                    Chợ Gia Dụng - nơi bạn tìm thấy những sản phẩm tốt nhất cho nhu cầu hàng ngày của bạn.
                </p>
            ...
            <div class="footer__col">
                ...
                <ul class="footer__list">
                    <li><p class="footer__label">Email</p><a href="mailto:contact@Chợ Gia Dụng.com" class="footer__link">contact@Chợ Gia Dụng.com</a></li>
        ...
        <div class="footer__bottom">
            <p class="footer__copyright">© 2010 - 2025 Chợ Gia Dụng. Bản quyền thuộc về Chợ Gia Dụng.</p>
