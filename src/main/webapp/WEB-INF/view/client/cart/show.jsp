  ...
  <div class="container">
    ...
    <div class="checkout-container">
      <c:if test="${empty cartDetails}">
        <h1 class="display-2 alert alert-danger text-center " style="display: block; font-size: 2.8rem;">Giỏ hàng của bạn đang trống.</h1>
      </c:if>
      <div class="row gy-xl-3">
                ...
                <article class="cart-item">
                  ...
                  <div class="cart-item__content">
                    <div class="cart-item__content-left">
                      ...
                      <p class="cart-item__price-wrap cart-item__status" contenteditable="true">
                        <c:choose>
                    ...
                    <div class="cart-item__content-right">
                      <p class="cart-item__total-price" contenteditable="true">
                        <c:choose>
                          <c:when test="${detail.quantity * detail.product.price != null}">
                            <c:if test="${detail.quantity * detail.product.price % 1 != 0}">
                              <fmt:formatNumber
                      ...
                      <div class="cart-item__ctrl">
                        ...
                        <form action="/delete-cart/${detail.id}" method="POST">
                          <input
                          type="hidden"
                        ...
                        />
                          <button type="submit"
                          class="cart-item__ctrl-btn is-delete" style="color: rgba(236, 77, 33, 0.973);"
                          toggle-target="#delete-confirm"
                        >
                        <i class="fas fa-trash "></i> <!-- Tăng kích thước gấp đôi -->
                        Xoá
                        </button>
                        </form>
              ...
              <div class="row">
                ...
                <div class="col-4 col-xxl-5">
                  <div class="cart-info__row">
                    <span>Tạm tính:</span>
                    <span class="sumPrice">  <c:choose>
                      <c:when test="${totalPrice != null}">
                        <c:if test="${totalPrice % 1 != 0}">
                          <fmt:formatNumber
                            value="${totalPrice}"
                            pattern="#,##0.000"
                          />
                  ...
                  <div class="cart-info__row cart-info__row--bold">
                    <span>Tổng cộng:</span>
                    <span class="totalPrice">$201.65</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-4 col-xl-12">
          <div class="cart-info">
            ...
            <a
              href="/clientPhí vận chuyển.html"
              ...
              <article class="gift-item">
                ...
                <div class="gift-item__content">
                  ...
                  <p class="gift-item__desc">
                    Các sản phẩm có sẵn sẽ được giao đến người nhận quà của bạn.
