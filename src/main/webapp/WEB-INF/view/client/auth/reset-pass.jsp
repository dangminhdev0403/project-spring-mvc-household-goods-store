...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="76x76" href="client/assets/favicon/apple-touch-icon.png" />
    ...
    <main class="auth">
        <div class="auth__content">
            <div class="auth__content-inner">
                ...
                <form action="/reset-pass" method="post" class="form auth__form">
                    ...
                    <div class="form__group auth__btn-group">
                        <button class="btn btn--primary auth__btn">Gửi yêu cầu</button>
                    </div>
                </form>

                <p class="auth__text">
                    Nhớ mật khẩu? <a href="/login" class="auth__link auth__text-link">Đăng Nhập</a>
                </p>
            </div>
        </div>
    </main>
