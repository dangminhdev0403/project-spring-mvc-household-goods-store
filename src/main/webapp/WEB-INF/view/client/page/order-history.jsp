      ...
      <div class="row gy-xl-3">
        <div class="col-8 col-xl-12">
          <div class="cart-info">
            ...
            <h2 class="cart-info__heading" style="font-size: 1.8rem">
                ...
                <div class="cart-item__content">
                  <div class="cart-item__content-left">
                    ...
                    <p class="cart-item__price-wrap">
                      <span class="format-price">
                        ${order.orderDetail[0].product.price}</span
                      >
                      |
                      <span class="cart-item__status">
                        ${order.status.displayName}</span
                      >
                    </p>
                  ...
                  <div class="cart-item__content-right">
                    <p class="cart-item__total-price format-price">
                      ${order.orderDetail[0].product.price *
              ...
              <div class="row">
                ...
                <div class="col-4 col-xxl-5">
                  <div class="cart-info__row">
                    <span
                      >Tạm tính
                      <span class="cart-info__sub-label">(sản phẩm)</span></span
                    >
                    <span class="format-price"
                      >${order.orderDetail[0].product.price *
                      order.orderDetail[0].quantity }</span
                    >
                  </div>
                  <div class="cart-info__row">
                    <span>Phí vận chuyển</span>
                    <span class="format-price">
                      ${order.totalPrice - order.orderDetail[0].product.price *
                      order.orderDetail[0].quantity }</span
                    >
                  </div>
                  <div class="cart-info__separate"></div>
        ...
        <div class="col-4 col-xl-12">
          <div class="cart-info">
            ...
            <div class="cart-info__row">
              <span
                >Tổng
                <span class="cart-info__sub-label">(Số lượng):</span></span
              >
              <span>3</span>
            </div>
            <div class="cart-info__row">
